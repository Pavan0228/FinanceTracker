    ...
    return (
        <div className="bg-gray-900 text-gray-300 min-h-screen py-8">
            <div className="container mx-auto px-4 max-w-4xl">
                <h1 className="text-3xl font-bold mb-6 text-center text-emerald-400">PennyWise Help & Information</h1>

                <HelpSection title="What is PennyWise?" icon={Info}>
                    <p className="mb-4">
                        PennyWise is an innovative automatic finance tracking application designed to simplify your financial management.
                ...
                <HelpSection title="Security Measures" icon={Lock}>
                    <p className="mb-4">Your privacy and data security are our top priorities. PennyWise employs several measures to ensure your information remains safe:</p>
                ...
                <HelpSection title="Troubleshooting" icon={AlertTriangle}>
                    <p className="mb-4">If you encounter any issues while using PennyWise, try these steps:</p>
                    <ol className="list-decimal pl-6 space-y-2">
